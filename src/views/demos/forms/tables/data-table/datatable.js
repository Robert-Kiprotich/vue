...
const data = [
  {
    ...
    from: 'HR001', // Short code for 'from'
    to: 'Puzi',
    cost: 19586.23,
    status: 'sent', // Mapped from status 1
  },
  {
    date: '09/23/2016',
    text: 'Nuclear Power Engineer',
    from: 'NP002', // Short code for 'from'
    to: 'Krasnosilka',
    cost: 23896.35,
    status: 'success', // Mapped from status 2
  },
  {
    date: '10/15/2017',
    text: 'Environmental Specialist',
    from: 'ES003', // Short code for 'from'
    to: 'Lampuyang',
    cost: 18991.67,
    status: 'rejected', // Mapped from status 3
  },
  {
    date: '06/12/2018',
    text: 'Sales Representative',
    from: 'SR004', // Short code for 'from'
    to: 'Colima',
    cost: 19252.12,
    status: 'user in blacklist', // Mapped from status 4
  },
  {
    date: '11/29/2023',
    text: 'Customer Support Agent',
    from: 'CSA005', // Short code for 'from'
    to: 'New York',
    cost: 15500.00,
    status: 'pending', // Example additional entry
  },
  {
    date: '09/27/2018',
    text: 'Human Resources Assistant',
